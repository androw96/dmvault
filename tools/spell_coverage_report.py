...
from backend.rules_engine import build_spell_coverage
from sqlalchemy import select


def main() -> int:
    parser = argparse.ArgumentParser(description="Report Playmode spell automation coverage.")
    ...
    coverage = build_spell_coverage(cards)
    if args.summary:
        print(json.dumps({
            "total_spells": coverage["total_spells"],
